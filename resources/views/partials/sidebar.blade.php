<aside id="sidebar" class="sidebar mini">
    ...
    <nav class="nav-scroll">
        ...
        <a class="side-link" href="#"><span class="pill"></span><i class="ico fa-solid fa-building"></i><span class="txt">العقارات</span></a>
        <a class="side-link" href="#"><span class="pill"></span><i class="ico fa-solid fa-door-open"></i><span class="txt">الوحدات</span></a>
        <a class="side-link" href="#"><span class="pill"></span><i class="ico fa-solid fa-users"></i><span class="txt">المستأجرين</span></a>
        <a class="side-link" href="#"><span class="pill"></span><i class="ico fa-solid fa-file-contract"></i><span class="txt">العقود</span></a>
